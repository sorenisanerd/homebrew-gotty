...
class Gotty < Formula
  ...
  url "https://github.com/sorenisanerd/gotty/releases/download/v1.1.0/gotty_v1.1.0_darwin_amd64.tar.gz"
  sha256 "604e790cf1b1f587a099aea29e8a8c2dc8cc4c2a424a827d8645b07f5497c45b"

  if OS.linux? && Hardware.is_64_bit?
      url "https://github.com/sorenisanerd/gotty/releases/download/v1.1.0/gotty_v1.1.0_linux_amd64.tar.gz"
